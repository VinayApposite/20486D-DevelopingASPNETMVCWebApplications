...
33. In the dialog box, navigate to **Allfiles\Mod01\Labfiles\01_ActorsRazorPages_begin\Pages**, select **Details.cshtml.cs** and **Details.cshtml**, and then click **Add**. 
    ...
    >**Note**: Examine the content of **Details.cshtml.cs** and **Details.cshtml**.
...
7. In the **AnimalsMvc - Microsoft Visual Studio** window, in **Solution Explorer**, under **AnimalsMvc**, expand **wwwroot**, expand **css**, and then click **site.css**.
    ...
    >**Note**: This is the CSS stylesheet file that was applied in **_Layout.cshtml**.
...
21. In the dialog box, navigate to **Allfiles\Mod01\Labfiles\03_AnimalsMvc_begin**, click **Data.cs**, and then click **Add**.
    ...
    >**Note**: Examine the content of **Data.cs** .
